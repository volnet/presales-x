...
const ATTRIBUTE_DEFS={
  word:[['author','作者',85],['lastEditor','最后一次保存者',90],['revision','修订号',55],['version','版本号',50],['application','程序名称',35],['company','公司',80],['manager','管理者',85],['created','创建内容的时间',65],['modified','最后一次保存的日期',75]],
  excel:[['author','作者',85],['lastEditor','最后一次保存者',90],['revision','修订号',55],['version','版本号',50],['application','程序名称',35],['company','公司',80],['manager','管理者',85],['created','创建内容的时间',65],['modified','最后一次保存的日期',75]],
  powerpoint:[['author','作者',85],['lastEditor','最后一次保存者',90],['revision','修订号',55],['version','版本号',50],['application','程序名称',35],['company','公司',80],['manager','管理者',85],['created','创建内容的时间',65],['modified','最后一次保存的日期',75]],
  pdf:[['author','作者',85],['title','标题',50],['subject','主题',45],['keywords','关键词',55],['creator','创建程序',40],['producer','制作工具',35],['created','创建时间',65],['modified','修改时间',75]],
  image:[['author','作者',85],['software','创建软件',35],['title','标题',45],['description','说明',35]]
};
const riskLevel=weight=>weight>=70?'高风险':weight>=45?'中风险':'低风险';
const attributeValue=(file,field)=>field==='version'?(file.attributes?.version||file.attributes?.appVersion):file.attributes?.[field];
